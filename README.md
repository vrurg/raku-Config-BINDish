...
See also [`Config::BINDish::Grammar`](docs/md/Config/BINDish/Grammar.md) and [`Config::BINDish::Actions`](docs/md/Config/BINDish/Actions.md).

# ATTRIBUTES

## [`Config::BINDish::Grammar::Strictness`](docs/md/Config/BINDish/Grammar/Strictness.md) `$.strict`

The default grammar strictness mode. See [`Config::BINDish::Grammar::Strictness`](docs/md/Config/BINDish/Grammar/Strictness.md) documentation for details.
...
Method is handled by `$.top` attribute. See [`Config::BINDish::AST::Blockish`](docs/md/Config/BINDish/AST/Blockish.md) for detailed method description.

# EXPORTS

By default this module exports only `BINDish-grammar` and `BINDish-actions` traits. But if `use`d with either "op" or "ascii-op" positional arguments it will also export *request operator* in either unicode or ASCII form:
...
More information about the operator can be found in [`Config::BINDish::Ops`](docs/md/Config/BINDish/Ops.md).
