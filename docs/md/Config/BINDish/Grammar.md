...
The most common way to extend the grammar would be to add a new kind of statement or a value type. This must be as easy as adding new `multi rule statement:sym<your-statement> {...}` or `multi token value:sym<your-type> {...}`.
